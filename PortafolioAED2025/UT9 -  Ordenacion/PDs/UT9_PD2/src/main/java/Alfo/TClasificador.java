...
public class TClasificador {
    ...
    public static final int METODO_CLASIFICACION_SHELL1 = 5;
    public static final int METODO_CLASIFICACION_SHELL2 = 6;
    public static final int METODO_CLASIFICACION_SHELL3 = 7;
    ...
    public int[] clasificar(int[] datosParaClasificar, int metodoClasificacion) {
        ...
        case METODO_CLASIFICACION_SHELL1:
            return ordenarPorShell1(datosParaClasificar);
    ...
    private int[] ordenarPorShell(int[] datosParaClasificar) {
        ...
        // int[] incrementos = new int[] { 301, 132, 57, 23, 10, 4, 1};
        // int[] incrementos = new int[] { 121, 40, 13, 4, 1};
        // int[] incrementos = new int[] { 112, 48, 21, 7, 3, 1};
    ...
    private int[] ordenarPorShell1(int[] datosParaClasificar) {
        int j, inc;
        int[] incrementos = new int[] { 301, 132, 57, 23, 10, 4, 1};
